    ...
    <div class="col-md-6">
      <form action="" method="get">
        <div class="input-group my-3">
          <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Search Studend(s)..." autofocus autocomplete="off">
          <button class="btn btn-primary" type="submit" id="button-addon2" name="search" id="search-button">Button</button>
        </div>
      </form>
    </div>
  </div>
